...
Shader "GAP/AlphaBlendedMobileDistortionScroll" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma multi_compile _ _MAIN_LIGHT_SHADOWS _ADDITIONAL_LIGHTS _ADDITIONAL_LIGHT_SHADOWS _SHADOWS_SOFT
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 _Distortion_var = SAMPLE_TEXTURE2D(_Distortion, sampler_Distortion, TRANSFORM_TEX(node_2765, _Distortion));
                ...
                float4 _MainTex_var = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, TRANSFORM_TEX(node_2151, _MainTex));
                float4 node_9160 = _Time;
                float2 node_6774 = (node_405+(node_9160.g*float2(_GradientUSpeed,_GradientVSpeed)));
                float4 _Gradient_var = SAMPLE_TEXTURE2D(_Gradient, sampler_Gradient, TRANSFORM_TEX(node_6774, _Gradient));
                float4 _MainTexMask_var = SAMPLE_TEXTURE2D(_MainTexMask, sampler_MainTexMask, TRANSFORM_TEX(i.uv0, _MainTexMask));
