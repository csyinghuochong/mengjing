    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes IN, uint instanceID : SV_InstanceID)
            {
                ...
                float3 positionOS = IN.positionOS.x * cameraTransformRightWS * _GrassWidth * (sin(perGrassPivotPosWS.x * 95.5 + perGrassPivotPosWS.z) * 0.45 + 0.55);
                positionOS += IN.positionOS.y * UNITY_MATRIX_V[1];
                ...
                OUT.color = MixFog(SampleSH(0) * albedo + ApplySingleDirectLight(mainLight, N, viewWS / ViewWSLength, albedo, positionOS.y), ComputeFogFactor(OUT.positionCS.z));
                return OUT;
            }
