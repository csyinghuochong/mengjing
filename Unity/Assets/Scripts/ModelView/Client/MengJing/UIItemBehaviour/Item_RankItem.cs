...
namespace ET.Client
{
	...
	public  class Scroll_Item_RankItem : Entity,IAwake,IDestroy,IUIScrollItem 
	{
		...
		public UnityEngine.UI.Button E_Button_WatchPetButton
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_Button_WatchPetButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_WatchPet");
     				}
     				return this.m_E_Button_WatchPetButton;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_WatchPet");
     			}
     		}
     	}

		public UnityEngine.UI.Image E_Button_WatchPetImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_Button_WatchPetImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_WatchPet");
     				}
     				return this.m_E_Button_WatchPetImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_WatchPet");
     			}
     		}
     	}
		...
		private UnityEngine.UI.Button m_E_Button_WatchPetButton = null;
		private UnityEngine.UI.Image m_E_Button_WatchPetImage = null;
