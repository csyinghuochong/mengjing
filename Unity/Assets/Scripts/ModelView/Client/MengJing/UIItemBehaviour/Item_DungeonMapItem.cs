...
{
	[EnableMethod]
	public  class Scroll_Item_DungeonMapItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_DungeonMapItem> 
	{
		...
		public Scroll_Item_DungeonMapItem BindTrans(Transform trans)
		{
