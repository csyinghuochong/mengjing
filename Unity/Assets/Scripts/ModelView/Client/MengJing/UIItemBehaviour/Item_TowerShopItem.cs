...
{
	[EnableMethod]
	public  class Scroll_Item_TowerShopItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_TowerShopItem> 
	{
		...
		public Scroll_Item_TowerShopItem BindTrans(Transform trans)
		{
