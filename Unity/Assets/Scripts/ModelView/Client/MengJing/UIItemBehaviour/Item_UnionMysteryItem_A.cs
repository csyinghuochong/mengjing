...
{
	[EnableMethod]
	public  class Scroll_Item_UnionMysteryItem_A : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_UnionMysteryItem_A>
	{
		...
		public Scroll_Item_UnionMysteryItem_A BindTrans(Transform trans)
		{
