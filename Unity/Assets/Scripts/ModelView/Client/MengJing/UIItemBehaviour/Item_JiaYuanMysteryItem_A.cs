...
{
	[EnableMethod]
	public  class Scroll_Item_JiaYuanMysteryItem_A : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_JiaYuanMysteryItem_A>
	{
		...
		public Scroll_Item_JiaYuanMysteryItem_A BindTrans(Transform trans)
		{
