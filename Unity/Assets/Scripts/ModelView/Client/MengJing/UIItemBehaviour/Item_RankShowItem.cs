...
namespace ET.Client
{
	[ChildOf]
	[EnableMethod]
	public  class Scroll_Item_RankShowItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_RankShowItem>
	{
		...
		public Scroll_Item_RankShowItem BindTrans(Transform trans)
		{
