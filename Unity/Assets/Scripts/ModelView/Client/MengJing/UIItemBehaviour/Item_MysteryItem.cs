...
{
	[EnableMethod]
	public  class Scroll_Item_MysteryItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_MysteryItem> 
	{
		...
		public Scroll_Item_MysteryItem BindTrans(Transform trans)
		{
