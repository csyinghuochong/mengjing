...
{
	[EnableMethod]
	public  class Scroll_Item_SelectAssistPetItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_SelectAssistPetItem> 
	{
		public int PetTuJianConfigId;
		public Action<int> OnSelectAssistPetItem;
		...
		public Scroll_Item_SelectAssistPetItem BindTrans(Transform trans)
		{
