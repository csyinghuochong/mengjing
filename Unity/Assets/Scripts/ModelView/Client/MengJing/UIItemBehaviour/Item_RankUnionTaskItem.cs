...
{
	[EnableMethod]
	public  class Scroll_Item_RankUnionTaskItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_RankUnionTaskItem>
	{
		...
		public Scroll_Item_RankUnionTaskItem BindTrans(Transform trans)
		{
