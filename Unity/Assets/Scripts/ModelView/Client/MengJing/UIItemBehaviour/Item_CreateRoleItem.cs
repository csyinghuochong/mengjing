...
namespace ET.Client
{
	...
	public  class Scroll_Item_CreateRoleItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_CreateRoleItem>
	{
		...
		public UnityEngine.UI.Image E_OccBadge_1Image
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if (this.isCacheNode)
     			{
     				if( this.m_E_OccBadge_1Image == null )
     				{
		    			this.m_E_OccBadge_1Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_Role/E_OccBadge_1");
     				}
     				return this.m_E_OccBadge_1Image;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_Role/E_OccBadge_1");
     			}
     		}
     	}

		public UnityEngine.UI.Image E_OccBadge_2Image
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if (this.isCacheNode)
     			{
     				if( this.m_E_OccBadge_2Image == null )
     				{
		    			this.m_E_OccBadge_2Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_Role/E_OccBadge_2");
     				}
     				return this.m_E_OccBadge_2Image;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_Role/E_OccBadge_2");
     			}
     		}
     	}
		...
		public void DestroyWidget()
		{
			...
			this.m_E_OccBadge_1Image = null;
			this.m_E_OccBadge_2Image = null;
		...
		private UnityEngine.UI.Image m_E_OccBadge_1Image = null;
		private UnityEngine.UI.Image m_E_OccBadge_2Image = null;
