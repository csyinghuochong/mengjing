...
namespace ET.Client
{
	...
	public  class Scroll_Item_UnionOrderItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_UnionOrderItem> 
	{
		...
		public Scroll_Item_UnionOrderItem BindTrans(Transform trans)
		{
		...
		public UnityEngine.UI.Image E_TaskIconImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if (this.isCacheNode)
     			{
     				if( this.m_E_TaskIconImage == null )
     				{
		    			this.m_E_TaskIconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_TaskIcon");
     				}
     				return this.m_E_TaskIconImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_TaskIcon");
     			}
     		}
     	}

		public UnityEngine.RectTransform EG_QulityListRectTransform
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if (this.isCacheNode)
     			{
     				if( this.m_EG_QulityListRectTransform == null )
     				{
		    			this.m_EG_QulityListRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_QulityList");
     				}
     				return this.m_EG_QulityListRectTransform;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_QulityList");
     			}
     		}
     	}
		...
		private UnityEngine.UI.Image m_E_TaskIconImage = null;
