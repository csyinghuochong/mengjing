...
{
	[EnableMethod]
	public  class Scroll_Item_SeasonJingHeItem : Entity,IAwake,IDestroy,IUIScrollItem 
	{
		public int JingHeId;
		...
		public Scroll_Item_SeasonJingHeItem BindTrans(Transform trans)
		{
			this.uiTransform = trans;
			return this;
		}

		public UnityEngine.UI.Image E_OutLineImgImage
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				if( this.m_E_OutLineImgImage == null )
     				{
		    			this.m_E_OutLineImgImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_OutLineImg");
     				}
     				return this.m_E_OutLineImgImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_OutLineImg");
     			}
     		}
     	}
		...
		public UnityEngine.UI.Image E_LockImgImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if (this.isCacheNode)
     			{
     				if( this.m_E_LockImgImage == null )
     				{
		    			this.m_E_LockImgImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_LockImg");
     				}
     				return this.m_E_LockImgImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_LockImg");
     			}
     		}
     	}
		...
		{
			this.m_E_OutLineImgImage = null;
			this.m_E_IconImgImage = null;
			this.m_E_LockImgImage = null;
		...
		private UnityEngine.UI.Image m_E_OutLineImgImage = null;
		private UnityEngine.UI.Image m_E_IconImgImage = null;
		private UnityEngine.UI.Image m_E_LockImgImage = null;
