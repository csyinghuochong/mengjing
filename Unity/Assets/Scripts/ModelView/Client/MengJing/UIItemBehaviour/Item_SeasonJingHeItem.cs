...
namespace ET.Client
{
	...
	public  class Scroll_Item_SeasonJingHeItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_SeasonJingHeItem>
	{
		...
		public Image E_OutLineImgImage
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_OutLineImgImage = UIFindHelper.FindDeepChild<Image>(this.uiTransform.gameObject,"E_OutLineImg");
     				}
     				return this.m_E_OutLineImgImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<Image>(this.uiTransform.gameObject,"E_OutLineImg");
     			}
     		}
     	}
		...
		public Image E_LockImgImage
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_LockImgImage = UIFindHelper.FindDeepChild<Image>(this.uiTransform.gameObject,"E_LockImg");
     				}
     				return this.m_E_LockImgImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<Image>(this.uiTransform.gameObject,"E_LockImg");
     			}
     		}
     	}
		...
		private Image m_E_OutLineImgImage = null;
		private Image m_E_IconImgImage = null;
		private Image m_E_LockImgImage = null;
