...
{
	[EnableMethod]
	public  class Scroll_Item_HuntTaskItem : Entity,IAwake,IDestroy,IUIScrollItem<Scroll_Item_HuntTaskItem>
	{
		...
		public Scroll_Item_HuntTaskItem BindTrans(Transform trans)
		{
		...
		public UnityEngine.UI.Image E_ItemIconImage
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_ItemIconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ItemInfo_1/E_ItemIcon");
     				}
     				return this.m_E_ItemIconImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ItemInfo_1/E_ItemIcon");
     			}
     		}
     	}
