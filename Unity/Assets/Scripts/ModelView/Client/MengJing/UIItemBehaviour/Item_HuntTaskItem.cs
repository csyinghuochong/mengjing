		...
		public Image E_ItemIconImage
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_ItemIconImage = UIFindHelper.FindDeepChild<Image>(this.uiTransform.gameObject,"ItemInfo_1/E_ItemIcon");
     				}
     				return this.m_E_ItemIconImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<Image>(this.uiTransform.gameObject,"ItemInfo_1/E_ItemIcon");
     			}
     		}
     	}
