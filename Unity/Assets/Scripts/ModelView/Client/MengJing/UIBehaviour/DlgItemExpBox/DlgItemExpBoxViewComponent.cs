...
namespace ET.Client
{
	...
	public  class DlgItemExpBoxViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Button E_Btn_MianFeiOpenButton
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Btn_MianFeiOpenButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Btn_MianFeiOpen");
     			}
     			return this.m_E_Btn_MianFeiOpenButton;
     		}
     	}

		public UnityEngine.UI.Image E_Btn_MianFeiOpenImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Btn_MianFeiOpenImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Btn_MianFeiOpen");
     			}
     			return this.m_E_Btn_MianFeiOpenImage;
     		}
     	}

		public UnityEngine.UI.Button E_Btn_ZuanShiOpenButton
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Btn_ZuanShiOpenButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Btn_ZuanShiOpen");
     			}
     			return this.m_E_Btn_ZuanShiOpenButton;
     		}
     	}

		public UnityEngine.UI.Image E_Btn_ZuanShiOpenImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Btn_ZuanShiOpenImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Btn_ZuanShiOpen");
     			}
		...
		public UnityEngine.EventSystems.EventTrigger E_Btn_AddEventTrigger
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_AddEventTrigger = UIFindHelper.FindDeepChild<UnityEngine.EventSystems.EventTrigger>(this.uiTransform.gameObject,"E_Btn_Add");
     			}
		...
		public UnityEngine.EventSystems.EventTrigger E_Btn_CostEventTrigger
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_CostEventTrigger = UIFindHelper.FindDeepChild<UnityEngine.EventSystems.EventTrigger>(this.uiTransform.gameObject,"E_Btn_Cost");
     			}
		...
		private UnityEngine.UI.Button m_E_Btn_MianFeiOpenButton = null;
		private UnityEngine.UI.Image m_E_Btn_MianFeiOpenImage = null;
		private UnityEngine.UI.Button m_E_Btn_ZuanShiOpenButton = null;
		private UnityEngine.UI.Image m_E_Btn_ZuanShiOpenImage = null;
