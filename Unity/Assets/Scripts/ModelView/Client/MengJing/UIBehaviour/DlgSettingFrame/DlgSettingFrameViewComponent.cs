		...
		public UnityEngine.UI.Button E_ButtonNormalButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonNormalButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_ButtonNormal");
     			}
		...
		public UnityEngine.UI.Image E_ButtonNormalImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonNormalImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_ButtonNormal");
     			}
		...
		public UnityEngine.UI.Button E_ButtonHighButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonHighButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_ButtonHigh");
     			}
		...
		public UnityEngine.UI.Image E_ButtonHighImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonHighImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_ButtonHigh");
     			}
