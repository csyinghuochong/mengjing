		...
		public UnityEngine.UI.LoopVerticalScrollRect E_SelectServerItem1LoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SelectServerItem1LoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_SelectServerItem1");
     			}
		...
		public UnityEngine.UI.LoopVerticalScrollRect E_SelectServerItem2LoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SelectServerItem2LoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_SelectServerItem2");
     			}
