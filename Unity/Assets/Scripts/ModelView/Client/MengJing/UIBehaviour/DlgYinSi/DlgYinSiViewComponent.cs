		...
		public UnityEngine.UI.Button E_TextButton_1Button
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextButton_1Button = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_TextButton_1");
     			}
		...
		public UnityEngine.UI.Text E_TextButton_1Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextButton_1Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextButton_1");
     			}
		...
		public UnityEngine.UI.Button E_TextButton_2Button
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextButton_2Button = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_TextButton_2");
     			}
		...
		public UnityEngine.UI.Text E_TextButton_2Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextButton_2Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextButton_2");
     			}
