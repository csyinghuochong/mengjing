...
namespace ET.Client
{
	[ChildOf]
	[EnableMethod]
	public  class ES_UnionMystery_B : Entity,IAwake<Transform>,IDestroy,IUILogic
	{
		public int BuyNum;
		public int SellId;
		...
		public UnityEngine.UI.Image E_BattleShopItemsImage
     	{
     		get
     		{
     			...
     			if( this.m_E_BattleShopItemsImage == null )
     			{
		    		this.m_E_BattleShopItemsImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Right/E_BattleShopItems");
     			}
     			return this.m_E_BattleShopItemsImage;
     		}
     	}
		...
		public UnityEngine.UI.LoopVerticalScrollRect E_BattleShopItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_BattleShopItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"Right/E_BattleShopItems");
     			}
		...
		public UnityEngine.UI.Text E_Lab_BuyPriceText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_BuyPriceText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"Right/PiLian/E_Lab_BuyPrice");
     			}
		...
		public UnityEngine.UI.Text E_Lab_BuyNumText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_BuyNumText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"Right/PiLian/E_Lab_BuyNum");
     			}
		...
		public UnityEngine.UI.Button E_Btn_BuyNum_jian10Button
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jian10Button = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jian10");
     			}
		...
		public UnityEngine.UI.Image E_Btn_BuyNum_jian10Image
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jian10Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jian10");
     			}
		...
		public UnityEngine.UI.Button E_Btn_BuyNum_jian1Button
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jian1Button = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jian1");
     			}
		...
		public UnityEngine.UI.Image E_Btn_BuyNum_jian1Image
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jian1Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jian1");
     			}
		...
		public UnityEngine.UI.Button E_Btn_BuyNum_jia10Button
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jia10Button = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jia10");
     			}
		...
		public UnityEngine.UI.Image E_Btn_BuyNum_jia10Image
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jia10Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jia10");
     			}
		...
		public UnityEngine.UI.Button E_Btn_BuyNum_jia1Button
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jia1Button = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jia1");
     			}
		...
		public UnityEngine.UI.Image E_Btn_BuyNum_jia1Image
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyNum_jia1Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Right/PiLian/E_Btn_BuyNum_jia1");
     			}
		...
		{
			this.m_E_BattleShopItemsImage = null;
		...
		private UnityEngine.UI.Image m_E_BattleShopItemsImage = null;
