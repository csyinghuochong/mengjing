		...
		public UnityEngine.UI.Button E_CloseBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CloseBtnButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"CostPanel/E_CloseBtn");
     			}
		...
		public UnityEngine.UI.Image E_CloseBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CloseBtnImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"CostPanel/E_CloseBtn");
     			}
		...
		public UnityEngine.UI.Button E_CostDiamondBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CostDiamondBtnButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"CostPanel/E_CostDiamondBtn");
     			}
		...
		public UnityEngine.UI.Image E_CostDiamondBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CostDiamondBtnImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"CostPanel/E_CostDiamondBtn");
     			}
		...
		public UnityEngine.UI.Button E_CostTicketBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CostTicketBtnButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"CostPanel/E_CostTicketBtn");
     			}
		...
		public UnityEngine.UI.Image E_CostTicketBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CostTicketBtnImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"CostPanel/E_CostTicketBtn");
     			}
