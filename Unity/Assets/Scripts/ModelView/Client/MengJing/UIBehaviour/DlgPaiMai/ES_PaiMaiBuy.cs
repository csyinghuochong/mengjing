		...
		public UnityEngine.UI.Button E_Btn_SearchButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_SearchButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Btn_Search");
     			}
		...
		public UnityEngine.UI.Image E_Btn_SearchImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_SearchImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Btn_Search");
     			}
		...
		public UnityEngine.RectTransform EG_ShowPageRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_ShowPageRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_ShowPage");
     			}
		...
		public UnityEngine.UI.Text E_Text_PageShowText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_PageShowText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EG_ShowPage/E_Text_PageShow");
     			}
		...
		public UnityEngine.UI.Button E_NextPageBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_NextPageBtnButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EG_ShowPage/E_NextPageBtn");
     			}
		...
		public UnityEngine.UI.Image E_NextPageBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_NextPageBtnImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_ShowPage/E_NextPageBtn");
     			}
		...
		public UnityEngine.UI.Button E_PrePageBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PrePageBtnButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EG_ShowPage/E_PrePageBtn");
     			}
		...
		public UnityEngine.UI.Image E_PrePageBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PrePageBtnImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_ShowPage/E_PrePageBtn");
     			}
