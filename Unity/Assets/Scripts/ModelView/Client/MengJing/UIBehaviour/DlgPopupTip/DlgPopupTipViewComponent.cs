		...
		public UnityEngine.UI.Button E_FalseButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_FalseButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_False");
     			}
		...
		public UnityEngine.UI.Image E_FalseImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_FalseImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_False");
     			}
