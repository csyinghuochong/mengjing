		...
		public UnityEngine.UI.Button E_FuLingBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_FuLingBtnButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_FuLingBtn");
     			}
		...
		public UnityEngine.UI.Image E_FuLingBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_FuLingBtnImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_FuLingBtn");
     			}
