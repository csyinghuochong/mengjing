...
namespace ET.Client
{
	...
	public  class DlgTeamDungeonCreateViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.RectTransform EG_TeamdungeonListRectTransform
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_EG_TeamdungeonListRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"ScrollView/Viewport/EG_TeamdungeonList");
     			}
     			return this.m_EG_TeamdungeonListRectTransform;
     		}
     	}

		public UnityEngine.RectTransform EG_TeamdungeonItemRectTransform
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_EG_TeamdungeonItemRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"ScrollView/Viewport/EG_TeamdungeonList/EG_TeamdungeonItem");
     			}
		...
		public UnityEngine.UI.Image E_ImageSelectImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ImageSelectImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ScrollView/Viewport/EG_TeamdungeonList/EG_TeamdungeonItem/E_ImageSelect");
     			}
		...
		private UnityEngine.RectTransform m_EG_TeamdungeonListRectTransform = null;
		private UnityEngine.RectTransform m_EG_TeamdungeonItemRectTransform = null;
