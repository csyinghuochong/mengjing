		...
		public UnityEngine.UI.Button E_ButtonDiHuanButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonDiHuanButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_ButtonDiHuan");
     			}
		...
		public UnityEngine.UI.Image E_ButtonDiHuanImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonDiHuanImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_ButtonDiHuan");
     			}
		...
		public UnityEngine.UI.Text E_Lab_ExpRateText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_ExpRateText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_ExpRate");
     			}
		...
		public UnityEngine.UI.Text E_Lab_ExpAddProText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_ExpAddProText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_ExpAddPro");
     			}
		...
		public UnityEngine.UI.Text E_Text_WorldLvText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_WorldLvText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Text_WorldLv");
     			}
		...
		public UnityEngine.UI.Text E_Lab_MyLv1Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_MyLv1Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_MyLv1");
     			}
		...
		public UnityEngine.UI.Text E_Lab_MyLv2Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_MyLv2Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_MyLv2");
     			}
		...
		public UnityEngine.UI.Text E_Lab_GanDiNameText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_GanDiNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_GanDiName");
     			}
		...
		public UnityEngine.UI.Text E_Lab_DuiHuanTimesText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_DuiHuanTimesText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_DuiHuanTimes");
     			}
