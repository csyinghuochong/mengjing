		...
		public UnityEngine.RectTransform EG_OneSellSetRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_OneSellSetRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_OneSellSet");
     			}
		...
		public UnityEngine.UI.Button E_Btn_OneSellButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_OneSellButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Btn_OneSell");
     			}
		...
		public UnityEngine.UI.Image E_Btn_OneSellImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_OneSellImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Btn_OneSell");
     			}
