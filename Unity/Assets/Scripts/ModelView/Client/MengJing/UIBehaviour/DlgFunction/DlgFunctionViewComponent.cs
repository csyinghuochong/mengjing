	...
	public  class DlgFunctionViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Button E_DragonDungeonButton
		{
			get
			{
				...
				{
					this.m_E_DragonDungeonButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Scroll View Left/Viewport/Content/E_DragonDungeon");
				}
		...
		public Button E_SingleHappy
		{
			get
			{
				...
				if( this.m_E_SingleHappy == null )
				{
					this.m_E_SingleHappy = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Scroll View Left/Viewport/Content/E_SingleHappy");
				}
				return this.m_E_SingleHappy;
			}
		}
		...
		private UnityEngine.UI.Button m_E_SingleHappy = null;
