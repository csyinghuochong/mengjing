		...
		public UnityEngine.UI.LoopVerticalScrollRect E_PetSelectItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PetSelectItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_PetSelectItems");
     			}
