		...
		public UnityEngine.RectTransform EG_TeamPlayerItem0RectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_TeamPlayerItem0RectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_TeamPlayerItem0");
     			}
		...
		public UnityEngine.RectTransform EG_TeamPlayerItem1RectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_TeamPlayerItem1RectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_TeamPlayerItem1");
     			}
		...
		public UnityEngine.RectTransform EG_TeamPlayerItem2RectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_TeamPlayerItem2RectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_TeamPlayerItem2");
     			}
		...
		public UnityEngine.UI.Text E_TextCountDownText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextCountDownText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextCountDown");
     			}
		...
		public UnityEngine.UI.Button E_Button_AgreeButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_AgreeButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_Agree");
     			}
		...
		public UnityEngine.UI.Image E_Button_AgreeImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_AgreeImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_Agree");
     			}
		...
		public UnityEngine.UI.Button E_Button_RefuseButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_RefuseButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_Refuse");
     			}
		...
		public UnityEngine.UI.Image E_Button_RefuseImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_RefuseImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_Refuse");
     			}
