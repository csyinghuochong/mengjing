		...
		public UnityEngine.RectTransform EG_SkillIPositionSetLeftRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_SkillIPositionSetLeftRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_SkillIPositionSetLeft");
     			}
		...
		public UnityEngine.RectTransform EG_SkillIPositionSetRightRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_SkillIPositionSetRightRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_SkillIPositionSetRight");
     			}
		...
		public UnityEngine.UI.Button E_ResetBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ResetBtnButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_ResetBtn");
     			}
		...
		public UnityEngine.UI.Image E_ResetBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ResetBtnImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_ResetBtn");
     			}
