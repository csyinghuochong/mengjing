		...
		public UnityEngine.UI.Image E_ChengJiuIconImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ChengJiuIconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Bottom/E_ChengJiuIcon");
     			}
		...
		public UnityEngine.UI.Text E_Text_ChengJiuNameText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_ChengJiuNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"Bottom/E_Text_ChengJiuName");
     			}
		...
		public UnityEngine.UI.Text E_Text_ChengJiuPointText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_ChengJiuPointText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"Bottom/E_Text_ChengJiuPoint");
     			}
		...
		public UnityEngine.UI.Text E_Text_ChengJiuDescText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_ChengJiuDescText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"Bottom/E_Text_ChengJiuDesc");
     			}
