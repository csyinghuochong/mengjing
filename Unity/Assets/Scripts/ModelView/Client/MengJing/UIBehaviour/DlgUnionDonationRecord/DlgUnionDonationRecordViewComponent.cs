		...
		public UnityEngine.RectTransform EG_UIUnionDonationRecordItemRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_UIUnionDonationRecordItemRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"ScrollView_2/Viewport/EG_BuildingList/EG_UIUnionDonationRecordItem");
     			}
