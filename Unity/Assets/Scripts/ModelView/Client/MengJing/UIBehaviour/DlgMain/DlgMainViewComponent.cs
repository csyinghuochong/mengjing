...
namespace ET.Client
{
	...
	public  class DlgMainViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public Toggle E_Team_Type_1Toggle
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Team_Type_1Toggle = UIFindHelper.FindDeepChild<Toggle>(this.uiTransform.gameObject,"EG_PhoneLeft/E_LeftTypeSet/E_Team_Type_1");
     			}
		...
		private Toggle m_E_Team_Type_1Toggle = null;
