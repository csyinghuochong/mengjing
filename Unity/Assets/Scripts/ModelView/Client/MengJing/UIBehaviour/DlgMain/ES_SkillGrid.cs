		...
		public UnityEngine.UI.Image E_Img_SkillIconImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Img_SkillIconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Img_Mask/E_Img_SkillIcon");
     			}
		...
		public UnityEngine.UI.Image E_Img_PublicSkillCDImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Img_PublicSkillCDImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Img_PublicSkillCD");
     			}
		...
		public UnityEngine.UI.Text E_Text_SkillItemNumText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_SkillItemNumText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Text_SkillItemNum");
     			}
