		...
		public UnityEngine.UI.Image E_MainCityShowImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_MainCityShowImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_MainCityShow");
     			}
		...
		public UnityEngine.UI.RawImage E_RawImageRawImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_RawImageRawImage = UIFindHelper.FindDeepChild<UnityEngine.UI.RawImage>(this.uiTransform.gameObject,"E_MainCityShow/ImageDi_1/E_RawImage");
     			}
		...
		public UnityEngine.RectTransform EG_HeadListRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_HeadListRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"E_MainCityShow/ImageDi_1/EG_HeadList");
     			}
		...
		public UnityEngine.RectTransform EG_HeadItemRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_HeadItemRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"E_MainCityShow/ImageDi_1/EG_HeadList/EG_HeadItem");
     			}
