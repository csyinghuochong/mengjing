...
namespace ET.Client
{
	...
	public  class DlgDungeonViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.LoopVerticalScrollRect E_DungeonItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_DungeonItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_DungeonItems");
     			}
		...
		private UnityEngine.UI.LoopVerticalScrollRect m_E_DungeonItemsLoopVerticalScrollRect = null;
