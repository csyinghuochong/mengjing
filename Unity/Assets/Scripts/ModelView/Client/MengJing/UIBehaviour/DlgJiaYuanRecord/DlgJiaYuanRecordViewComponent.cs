...
namespace ET.Client
{
	...
	public  class DlgJiaYuanRecordViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.RectTransform EG_UIJiaYuanRecordItemRectTransform
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_EG_UIJiaYuanRecordItemRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"ScrollView2/Viewport/EG_BuildingList2/EG_UIJiaYuanRecordItem");
     			}
		...
		private UnityEngine.RectTransform m_EG_UIJiaYuanRecordItemRectTransform = null;
