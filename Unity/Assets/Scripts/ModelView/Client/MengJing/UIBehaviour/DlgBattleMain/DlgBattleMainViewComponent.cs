		...
		public UnityEngine.UI.Text E_TextVS_1Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextVS_1Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextVS_1");
     			}
		...
		public UnityEngine.UI.Text E_TextVS_2Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextVS_2Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextVS_2");
     			}
		...
		public UnityEngine.UI.Text E_TextVS_KillText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextVS_KillText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextVS_Kill");
     			}
		...
		public UnityEngine.UI.Text E_CountDownTimeText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CountDownTimeText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_CountDownTime");
     			}
