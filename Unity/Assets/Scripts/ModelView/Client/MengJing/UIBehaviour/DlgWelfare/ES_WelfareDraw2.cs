...
namespace ET.Client
{
	[ChildOf]
	[EnableMethod]
	public  class ES_WelfareDraw2 : Entity,ET.IAwake<UnityEngine.Transform>,IDestroy
	{
		...
		public ES_RewardList ES_RewardList_1
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_1 .Equals(null) )
     			{
		...
		public ES_RewardList ES_RewardList_2
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_2 .Equals(null)  )
     			{
		...
		public ES_RewardList ES_RewardList_3
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_3 .Equals(null)  )
     			{
		...
		public ES_RewardList ES_RewardList_4
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_4 .Equals(null) )
     			{
		...
		public ES_RewardList ES_RewardList_5
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_5 .Equals(null)  )
     			{
		...
		public ES_RewardList ES_RewardList_6
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_6.Equals(null) )
     			{
		...
		public ES_RewardList ES_RewardList_7
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_7 .Equals(null) )
     			{
		...
		public ES_RewardList ES_RewardList_8
     	{
     		get
     		{
     			...
     			if( this.m_es_rewardlist_8 .Equals(null) )
     			{
