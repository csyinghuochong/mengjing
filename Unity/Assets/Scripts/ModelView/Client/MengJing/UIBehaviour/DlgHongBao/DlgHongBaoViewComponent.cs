		...
		public UnityEngine.RectTransform EG_JiaGeSetRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_JiaGeSetRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_JiaGeSet");
     			}
		...
		public UnityEngine.UI.Text E_Text_AmountText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_AmountText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EG_JiaGeSet/E_Text_Amount");
     			}
		...
		public UnityEngine.UI.Button E_Button_OpenButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_OpenButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_Open");
     			}
		...
		public UnityEngine.UI.Image E_Button_OpenImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_OpenImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_Open");
     			}
