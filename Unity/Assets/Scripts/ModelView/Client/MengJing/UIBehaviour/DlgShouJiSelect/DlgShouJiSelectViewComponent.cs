		...
		public UnityEngine.UI.Button E_ButtonTunShiButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonTunShiButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_ButtonTunShi");
     			}
		...
		public UnityEngine.UI.Image E_ButtonTunShiImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonTunShiImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_ButtonTunShi");
     			}
