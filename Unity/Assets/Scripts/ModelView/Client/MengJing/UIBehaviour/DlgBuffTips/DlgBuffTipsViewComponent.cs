		...
		public UnityEngine.UI.Button E_ImageButtonButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ImageButtonButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EG_PositionNode/E_ImageButton");
     			}
		...
		public UnityEngine.UI.Image E_ImageButtonImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ImageButtonImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_PositionNode/E_ImageButton");
     			}
		...
		public UnityEngine.UI.Text E_Lab_BuffTimeText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_BuffTimeText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EG_PositionNode/E_Lab_BuffTime");
     			}
		...
		public UnityEngine.UI.Text E_Lab_SpellcasterText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_SpellcasterText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EG_PositionNode/E_Lab_Spellcaster");
     			}
