		...
		public UnityEngine.UI.Button E_ImgCloseButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ImgCloseButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_ImgClose");
     			}
		...
		public UnityEngine.UI.Image E_ImgCloseImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ImgCloseImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_ImgClose");
     			}
		...
		public UnityEngine.UI.Text E_TextTip3Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextTip3Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextTip3");
     			}
