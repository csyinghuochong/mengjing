		...
		public UnityEngine.UI.Text E_Label_ItemFumo_0Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Label_ItemFumo_0Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Label_ItemFumo_0");
     			}
		...
		public UnityEngine.UI.Text E_Label_ItemFumo_1Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Label_ItemFumo_1Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Label_ItemFumo_1");
     			}
		...
		public UnityEngine.UI.Text E_Label_ItemFumo_2Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Label_ItemFumo_2Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Label_ItemFumo_2");
     			}
