		...
		public UnityEngine.RectTransform EG_UIPetHeXinSuitItemListNodeRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_UIPetHeXinSuitItemListNodeRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_UIPetHeXinSuitItemListNode");
     			}
		...
		public UnityEngine.UI.Image E_UIPetHeXinSuitItemImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_UIPetHeXinSuitItemImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_UIPetHeXinSuitItemListNode/E_UIPetHeXinSuitItem");
     			}
