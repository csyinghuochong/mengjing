...
namespace ET.Client
{
	[ChildOf]
	[EnableMethod]
	public  class ES_TeamDungeonMy : Entity,ET.IAwake<UnityEngine.Transform>,IDestroy 
	{
		...
		public UnityEngine.UI.Button E_Button_CallButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_CallButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_Call");
     			}
		...
		public UnityEngine.UI.Image E_Button_CallImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_CallImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_Call");
     			}
		...
		public UnityEngine.UI.Button E_Button_LeaveButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_LeaveButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_Leave");
     			}
		...
		public UnityEngine.UI.Image E_Button_LeaveImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_LeaveImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_Leave");
     			}
		...
		public UnityEngine.UI.Button E_Button_RobotButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_RobotButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_Robot");
     			}
		...
		public UnityEngine.UI.Image E_Button_RobotImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_RobotImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_Robot");
     			}
		...
		public UnityEngine.UI.Text E_Lab_FuBenNameText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_FuBenNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_FuBenName");
     			}
		...
		public UnityEngine.UI.Text E_Lab_FuBenLvText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Lab_FuBenLvText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Lab_FuBenLv");
     			}
