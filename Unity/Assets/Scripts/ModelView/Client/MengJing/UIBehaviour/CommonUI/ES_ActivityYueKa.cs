		...
		public UnityEngine.UI.Image E_Img_JiHuoImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Img_JiHuoImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Img_JiHuo");
     			}
		...
		public UnityEngine.UI.Text E_Text_RemainingtimesText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Text_RemainingtimesText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Text_Remainingtimes");
     			}
