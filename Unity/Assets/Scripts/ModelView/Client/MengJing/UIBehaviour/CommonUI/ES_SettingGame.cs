		...
		public UnityEngine.UI.Button E_Btn_YinYingButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_YinYingButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"ScrollView/Viewport/Content/UIGameSetting/YinYing/E_Btn_YinYing");
     			}
		...
		public UnityEngine.UI.Image E_Btn_YinYingImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_YinYingImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ScrollView/Viewport/Content/UIGameSetting/YinYing/E_Btn_YinYing");
     			}
		...
		public UnityEngine.UI.Image E_Image_YinYingImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Image_YinYingImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ScrollView/Viewport/Content/UIGameSetting/YinYing/E_Image_YinYing");
     			}
