		...
		public UnityEngine.EventSystems.EventTrigger E_RenderEventTrigger
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_RenderEventTrigger = UIFindHelper.FindDeepChild<UnityEngine.EventSystems.EventTrigger>(this.uiTransform.gameObject,"E_Render");
     			}
		...
		public UnityEngine.RectTransform EG_RootRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_RootRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"E_Render/EG_Root");
     			}
