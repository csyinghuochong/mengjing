...
namespace ET.Client
{
	[ChildOf]
	[EnableMethod]
	public  class ES_ChatView : Entity,ET.IAwake<UnityEngine.Transform>,IDestroy 
	{
		public UnityEngine.UI.Text E_ChatPlayNameText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ChatPlayNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"ImageDi/E_ChatPlayName");
     			}
		...
		public UnityEngine.UI.InputField E_InputInputField
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_InputInputField = UIFindHelper.FindDeepChild<UnityEngine.UI.InputField>(this.uiTransform.gameObject,"E_Input");
     			}
		...
		public UnityEngine.UI.Image E_InputImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_InputImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Input");
     			}
		...
		public UnityEngine.UI.LoopVerticalScrollRect E_FriendChatItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_FriendChatItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_FriendChatItems");
     			}
		...
		public UnityEngine.UI.Button E_CloseChatButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CloseChatButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_CloseChat");
     			}
		...
		public UnityEngine.UI.Image E_CloseChatImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CloseChatImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_CloseChat");
     			}
