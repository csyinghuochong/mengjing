...
namespace ET.Client
{
	[ChildOf]
	[EnableMethod]
	public  class ES_BattleTask : Entity,ET.IAwake<UnityEngine.Transform>,IDestroy 
	{
		public UnityEngine.UI.LoopVerticalScrollRect E_BattleTaskItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_BattleTaskItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_BattleTaskItems");
     			}
