...
namespace ET.Client
{
	...
	public  class DlgJiaYuanPlanWatchViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Button E_BtnCloseButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_BtnCloseButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_BtnClose");
     			}
		...
		public UnityEngine.UI.Image E_BtnCloseImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_BtnCloseImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_BtnClose");
     			}
		...
		public UnityEngine.UI.Text E_TextStageText
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_TextStageText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TextStage");
     			}
     			return this.m_E_TextStageText;
     		}
     	}

		public UnityEngine.UI.Text E_Text_Desc_1Text
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Text_Desc_1Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Text_Desc_1");
     			}
     			return this.m_E_Text_Desc_1Text;
     		}
     	}

		public UnityEngine.UI.Text E_Text_Desc_2Text
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Text_Desc_2Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Text_Desc_2");
     			}
     			return this.m_E_Text_Desc_2Text;
     		}
     	}

		public UnityEngine.UI.Text E_Text_Desc_3Text
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Text_Desc_3Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Text_Desc_3");
     			}
     			return this.m_E_Text_Desc_3Text;
     		}
     	}

		public UnityEngine.UI.Text E_Text_RecordText
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_E_Text_RecordText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Text_Record");
     			}
		...
		private UnityEngine.UI.Text m_E_TextStageText = null;
		private UnityEngine.UI.Text m_E_Text_Desc_1Text = null;
		private UnityEngine.UI.Text m_E_Text_Desc_2Text = null;
		private UnityEngine.UI.Text m_E_Text_Desc_3Text = null;
		private UnityEngine.UI.Text m_E_Text_RecordText = null;
