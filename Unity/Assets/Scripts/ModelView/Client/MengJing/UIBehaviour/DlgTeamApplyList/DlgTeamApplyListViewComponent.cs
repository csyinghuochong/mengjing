		...
		public UnityEngine.UI.LoopVerticalScrollRect E_TeamApplyItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TeamApplyItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_TeamApplyItems");
     			}
