		...
		public UnityEngine.UI.Image E_ImagePetHexinItemIconImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ImagePetHexinItemIconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_ImagePetHexinItemIcon");
     			}
		...
		public UnityEngine.UI.Button E_Button_OneKeyButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_OneKeyButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Button_OneKey");
     			}
		...
		public UnityEngine.UI.Image E_Button_OneKeyImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Button_OneKeyImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Button_OneKey");
     			}
		...
		public UnityEngine.UI.LoopVerticalScrollRect E_PetHeXinListLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PetHeXinListLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_PetHeXinList");
     			}
