		...
		public UnityEngine.RectTransform EG_ButtonListRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_ButtonListRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_ButtonList");
     			}
		...
		public UnityEngine.UI.Button E_ButtonCancelButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonCancelButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EG_ButtonList/E_ButtonCancel");
     			}
		...
		public UnityEngine.UI.Image E_ButtonCancelImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonCancelImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_ButtonList/E_ButtonCancel");
     			}
		...
		public UnityEngine.UI.Button E_ButtonConfirmButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonConfirmButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EG_ButtonList/E_ButtonConfirm");
     			}
		...
		public UnityEngine.UI.Image E_ButtonConfirmImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ButtonConfirmImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_ButtonList/E_ButtonConfirm");
     			}
