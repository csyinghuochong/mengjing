		...
		public UnityEngine.UI.LoopVerticalScrollRect E_ZhanQuCombatItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ZhanQuCombatItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"E_ZhanQuCombatItems");
     			}
		...
		public UnityEngine.UI.Text E_MyCombatText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_MyCombatText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_MyCombat");
     			}
