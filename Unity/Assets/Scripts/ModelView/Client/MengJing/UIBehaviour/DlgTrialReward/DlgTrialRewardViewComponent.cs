...
namespace ET.Client
{
	...
	public  class DlgTrialRewardViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.RectTransform EG_RewardListNodeRectTransform
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_EG_RewardListNodeRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"ScrollView1/Viewport/EG_RewardListNode");
     			}
		...
		private UnityEngine.RectTransform m_EG_RewardListNodeRectTransform = null;
