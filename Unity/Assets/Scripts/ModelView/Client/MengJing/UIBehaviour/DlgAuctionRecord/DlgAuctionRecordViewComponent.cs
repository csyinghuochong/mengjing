		...
		public UnityEngine.RectTransform EG_UIAuctionRecordItemRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_UIAuctionRecordItemRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"ScrollView_2/Viewport/EG_BuildingList/EG_UIAuctionRecordItem");
     			}
