		...
		public UnityEngine.RectTransform EG_UnActiveTipRectTransform
     	{
     		get
     		{
     			...
     			{
		    		this.m_EG_UnActiveTipRectTransform = UIFindHelper.FindDeepChild<UnityEngine.RectTransform>(this.uiTransform.gameObject,"EG_PositionNode/EG_UnActiveTip");
     			}
		...
		public UnityEngine.UI.Text E_TextTip2Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TextTip2Text = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EG_PositionNode/EG_UnActiveTip/E_TextTip2");
     			}
