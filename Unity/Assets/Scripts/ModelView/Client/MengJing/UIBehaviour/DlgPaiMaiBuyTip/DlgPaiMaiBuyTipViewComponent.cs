		...
		public UnityEngine.UI.Text E_UnitPriceTextText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_UnitPriceTextText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_UnitPriceText");
     			}
		...
		public UnityEngine.UI.Text E_TotalPriceTextText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_TotalPriceTextText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TotalPriceText");
     			}
		...
		public UnityEngine.UI.Button E_Btn_BuyButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Btn_Buy");
     			}
		...
		public UnityEngine.UI.Image E_Btn_BuyImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_BuyImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Btn_Buy");
     			}
