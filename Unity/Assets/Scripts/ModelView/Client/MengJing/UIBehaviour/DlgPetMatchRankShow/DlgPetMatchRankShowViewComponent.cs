		...
		public UnityEngine.UI.LoopVerticalScrollRect E_PetMatchRankShowItemsLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PetMatchRankShowItemsLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"EG_UISet/E_PetMatchRankShowItems");
     			}
