		...
		public ES_ChengJiuReward ES_ChengJiuReward
     	{
     		get
     		{
     			...
     			if( this.m_es_chengjiureward .Equals(null) )
     			{
		...
		public ES_ChengJiuShow ES_ChengJiuShow
     	{
     		get
     		{
     			...
     			if( this.m_es_chengjiushow .Equals(null))
     			{
		...
		public ES_ChengJiuJingling ES_ChengJiuJingling
     	{
     		get
     		{
     			...
     			if( this.m_es_chengjiujingling .Equals(null))
     			{
		...
		public ES_PetTuJian ES_PetTuJian
     	{
     		get
     		{
     			...
     			if( this.m_es_pettujian .Equals(null) )
     			{
