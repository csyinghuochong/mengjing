		...
		public ES_ItemAppraisalTips ES_ItemAppraisalTips_1
     	{
     		get
     		{
     			...
     			if( this.m_es_itemappraisaltips_1 .Equals(null) )
     			{
		...
		public ES_EquipTips ES_EquipTips_1
     	{
     		get
     		{
     			...
     			if( this.m_es_equiptips_1 .Equals(null) )
     			{
		...
		public ES_ItemAppraisalTips ES_ItemAppraisalTips_2
     	{
     		get
     		{
     			...
     			if( this.m_es_itemappraisaltips_2 .Equals(null) )
     			{
		...
		public ES_EquipTips ES_EquipTips_2
     	{
     		get
     		{
     			...
     			if( this.m_es_equiptips_2 .Equals(null))
     			{
