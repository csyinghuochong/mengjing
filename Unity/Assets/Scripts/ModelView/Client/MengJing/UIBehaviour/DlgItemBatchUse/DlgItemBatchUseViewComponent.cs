		...
		public UnityEngine.UI.Button E_Btn_OpenButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_OpenButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Btn_Open");
     			}
		...
		public UnityEngine.UI.Image E_Btn_OpenImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_Btn_OpenImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Btn_Open");
     			}
