...
namespace ET.Client
{
    ...
    public static partial class ChangeEquipComponentSystem
    {
        ...
        public static int get2Pow(this ChangeEquipComponent self, int into)
        {
            int outo = 1;
            for (int i = 0; i < 10; i++)
            {
        ...
        public static void OnLoadGameObject(this ChangeEquipComponent self, GameObject go, long formId)
        {
            if (self.IsDisposed)
            {
                //删除加载出来的子部件
        ...
        public static void OnAllLoadComplete_2(this ChangeEquipComponent self)
        {
        ...
        public static void ProcessMeshRender(this ChangeEquipComponent self, SkinnedMeshRenderer thisRender, Transform rootObj)
        {
        ...
        public static Transform FindChildByName(this ChangeEquipComponent self, string thisName, Transform thisObj)
        {
        ...
        public static void OnAllLoadComplete(this ChangeEquipComponent self)
        {
        ...
        public static List<string> GetPartsPath(this ChangeEquipComponent self, int occ, int subType, int fashonid)
        {
        ...
        public static void OnLoadGameObject_Weapon(this ChangeEquipComponent self, GameObject go, long formId)
        {
        ...
        public static void ShowWeapon(this ChangeEquipComponent self, GameObject hero, int occ, int equipIndex, int weaponId, bool rimLight)
        {
            if (hero == null)
            {
                return;
