    ...
    public static partial class ES_ItemAppraisalTipsSystem
    {
        ...
        public static void RefreshInfo(this ES_ItemAppraisalTips self, BagInfo bagInfo, ItemOperateEnum itemOperateEnum, int currentHouse)
        {
            ...
            if (!string.IsNullOrEmpty(bagInfo.MakePlayer))
            {
                ...
                self.E_ItemMakeText.text = $"此装备由<color=#805100>{self.BagInfo.MakePlayer}</color>打造";
            }
            else
            {
            ...
            if (itemType == 3)
            {
                ...
                self.E_ItemTypeText.text = "部位:" + textEquipType;
            }
            ...
            if (itemType == 3 && itemconf.EquipType == 201)
            {
                ...
                self.E_ItemJingHeQualityText.text = $"当前品质:{bagInfo.ItemPar}";
            ...
            */
            ...
            {
                self.E_ItemLvText.text = langStr + ":1";
            }
        }
