        ...
        private static async ETTask OnUpdateUI(this ES_RankShow self, int type = 0)
        {
            ...
            for (int i = 0; i < response.RankList.Count; i++)
            {
                ...
                if (rank == 1)
                {
                    ...
                    self.ES_ModelShow_1.SetPosition(Vector3.zero, new Vector3(0f, 70f, 150f));
                ...
                if (rank == 2)
                {
                    ...
                    self.ES_ModelShow_2.SetPosition(Vector3.zero, new Vector3(0f, 70f, 150f));
                ...
                if (rank == 3)
                {
                    ...
                    self.ES_ModelShow_3.SetPosition(Vector3.zero, new Vector3(0f, 70f, 150f));
