...
namespace ET.Client
{
    ...
    public static partial class ES_PetInfoShowSystem
    {
        ...
        private static void UpdateAttribute(this ES_PetInfoShow self, RolePetInfo rolePetInfo)
        {
            ...
            self.E_Text_PetLevelText.text = rolePetInfo.PetLv + GameSettingLanguge.LoadLocalization("级");
        ...
        private static void CheckNoPet(this ES_PetInfoShow self, bool havepet)
        {
            self.E_Img_PetHeroIonImage.gameObject.SetActive(havepet);
            self.E_Img_PeteroQualityaddImage.gameObject.SetActive(!havepet);
