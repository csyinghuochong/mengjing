...
namespace ET.Client
{
    ...
    public static partial class ES_PetListSystem
    {
        ...
        public static void UpdatePetHeXin(this ES_PetList self, RolePetInfo rolePetItem)
        {
        ...
        private static void UpdatePetHexinItem(this ES_PetList self, List<ItemInfo> bagInfos)
        {
        ...
        private static void OnUpdateItemList(this ES_PetList self, List<ItemInfo> bagInfos)
        {
            self.BagInfo = null;
        ...
        private static void SelectItemHandlder(this ES_PetList self, ItemInfo bagInfo)
        {
        ...
        private static void UpdatePetZizhi(this ES_PetList self, RolePetInfo rolePetInfo)
        {
            ...
            //        ziZhi_HpProp >= 1 ? sprite16 : sprite17;
            ...
            //       ziZhi_ActProp>=1f ? sprite16 : sprite17;
            ...
            //        ziZhi_DefProp>=1f ? sprite16 : sprite17;
            ...
            //        ziZhi_AdfProp >= 1f  ? sprite16 : sprite17;
            ...
            //        ziZhi_ChengZhangProp >= 1f  ? sprite16 : sprite17;
            ...
            //        ziZhi_MageActProp >= 1f ? sprite16 : sprite17;
