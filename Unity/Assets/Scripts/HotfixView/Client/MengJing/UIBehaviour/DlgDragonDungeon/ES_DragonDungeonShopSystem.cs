...
namespace ET.Client
{
    ...
    public static partial class ES_DragonDungeonShopSystem
    {
        ...
        public static void OnButtonBuyButton(this ES_DragonDungeonShop self)
        {
            if (self.SellId == 0)
            {
        ...
        public static void OnClickHandler(this ES_DragonDungeonShop self, int sellId)
        {
            self.SellId = sellId;
        ...
        public static void OnClickChangeBuyNum(this ES_DragonDungeonShop self, int num)
        {
        ...
        public static void OnUpdateUI(this ES_DragonDungeonShop self)
        {
            //更新自身拥有的货币显示
        ...
        private static void OnBattleShopItemsRefresh(this ES_DragonDungeonShop self, Transform transform, int index)
        {
