...
namespace ET.Client
{
    ...
    public static partial class Scroll_Item_BattleTaskItemSystem
    {
        ...
        public static void OnUpdateData(this Scroll_Item_BattleTaskItem self, TaskPro taskPro)
        {
        ...
        public static void OnBtn_Receive(this Scroll_Item_BattleTaskItem self)
        {
