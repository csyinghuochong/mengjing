...
namespace ET.Client
{
    ...
    public static partial class Scroll_Item_PaiMaiShopItemSystem
    {
        ...
        public static void OnUpdateData(this Scroll_Item_PaiMaiShopItem self, int paimaiId, PaiMaiShopItemInfo shopItemInfo)
        {
            ...
            self.ES_CommonItem.UpdateItem(new BagInfo() { BagInfoID = paimaiId, ItemID = paiMaiSellConfig.ItemID }, ItemOperateEnum.None);
            ...
            self.E_Lab_TipsText.text = GameSettingLanguge.LoadLocalization(des);
        }
    }
}