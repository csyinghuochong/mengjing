...
namespace ET.Client
{
    ...
    public static class DlgSkillTipsSystem
    {
        ...
        string aBAtlasTypes = ABAtlasTypes.RoleSkillIcon, string addTip = "")
        {
            ...
            {
                self.View.E_Lab_SkillTypeText.text = GameSettingLanguge.LoadLocalization("类型：主动技能");
            }
            else
            {
                self.View.E_Lab_SkillTypeText.text = GameSettingLanguge.LoadLocalization("类型：被动技能");
            }
