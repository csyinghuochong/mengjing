...
namespace ET.Client
{
	...
	public class UICellDungeonSettlement : ATimer<DlgCellDungeonSettlementSelectReward>
	{
		protected override void Run(DlgCellDungeonSettlementSelectReward self)
		{
			try
			{
				self.Update();
	...
	[FriendOf(typeof(DlgCellDungeonSettlementSelectReward))]
	public static  class DlgCellDungeonSettlementSelectRewardSystem
	{

		public static void RegisterUIEvent(this DlgCellDungeonSettlementSelectReward self)
		{
			self.GetPassTime = 0;
		...
		public static void ShowWindow(this DlgCellDungeonSettlementSelectReward self, Entity contextData = null)
		{
		}

		public static void BeforeUnload(this DlgCellDungeonSettlementSelectReward self)
		{
			self.Root().GetComponent<TimerComponent>().Remove(ref self.Timer);
		}

		public static void Update(this DlgCellDungeonSettlementSelectReward self)
		{
		...
		public static void Check(this DlgCellDungeonSettlementSelectReward self)
		{
			self.LeftTime--;
			if (self.LeftTime < 0)
			{
		...
		public static void OnCloseButton(this DlgCellDungeonSettlementSelectReward self)
		{
			...
			self.Root().GetComponent<UIComponent>().CloseWindow(WindowID.WindowID_CellDungeonSettlementSelectReward);
		}
		
		public static void OnExitButton(this DlgCellDungeonSettlementSelectReward self)
		{
			EnterMapHelper.RequestQuitFuben(self.Root());
			self.Root().GetComponent<UIComponent>().CloseWindow(WindowID.WindowID_CellDungeonSettlementSelectReward);
		}
		
		public static void OnCheckGetReward(this DlgCellDungeonSettlementSelectReward self)
        {
            if (self.topSelect && self.bottomSelect)
            {
                return;
        ...
        public static void OnButtonContinue(this DlgCellDungeonSettlementSelectReward self)
        {
        ...
        public static async ETTask OnUpdateUI(this DlgCellDungeonSettlementSelectReward self, M2C_FubenSettlement m2C_FubenSettlement)
        {
	        //奖励列表
