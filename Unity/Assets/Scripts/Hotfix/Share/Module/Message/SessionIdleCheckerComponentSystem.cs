...
namespace ET
{
    ...
    public static partial class SessionIdleCheckerComponentSystem
    {
        ...
        private static void Check(this SessionIdleCheckerComponent self)
        {
            ...
            Console.WriteLine($"session timeout: {session.Id} {timeNow} {session.LastRecvTime} {session.LastSendTime} {timeNow - session.LastRecvTime} {timeNow - session.LastSendTime}");
