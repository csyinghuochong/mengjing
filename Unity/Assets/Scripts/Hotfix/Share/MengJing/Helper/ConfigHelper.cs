...
namespace ET
{
    ...
    public static class ConfigHelper
    {
        ...
        //购买仓库
        public static List<BuyCellCost> BuyStoreCellCosts()
        {
            return new List<BuyCellCost>
        {
            //仓库1
        ...
        //客戶端活动提示
        public static List<ActivityTipConfig> ActivityShowList()
        {
            return new List<ET.ActivityTipConfig>
            {
        ...
        /// 宠物守护队伍开启等级
        /// </summary>
        public static List<int> PetMiningTeamOpenLevel()
        {
            return  new List<int>() { 1, 30, 40 };
        }

        /// <summary>
        /// 宠物矿场
        /// </summary>
        public static Dictionary<int, List<PetMiningItem>> PetMiningList()
        {
            return new Dictionary<int, List<PetMiningItem>>()
        {
        ...
        /// </summary>
        public static List<KeyValuePair> WelfareDrawList()
        {
            return new List<KeyValuePair>
            {
                //第一天
        ...
        /// </summary>
        public static List<KeyValuePair> WelfareInvestList()
        {
            return  new List<KeyValuePair>()
            { 
        ...
        /// 完成每天目标任务的奖励
        /// </summary>
        public static List<string> WelfareTaskReward()
        {
            return new List<string>() { "10000161;1@10010033;1@10010092;1", "10000161;1@10010051;1@10010093;1", "10000161;1@10000158;1@10010046;1", "10000161;1@10010033;1@10010086;1", "10000161;1@10010040;1@10000158;1", "10000161;1@10000143;3@10010086;1", "10000161;1@10049003;1@10010052;1" };
        ...
        /// 一键出售材料
        /// </summary>
        public static List<int> OneSellMaterialList()
        {
            return new List<int>()
            {
        ...
        /// 跑环任务奖励
        /// </summary>
        public static Dictionary<int, int> RingTaskDrop()
        {
            return new Dictionary<int, int>()
            {
        ...
        {
                return  "10000136;1@10010078;1@10010079;1@10010093;1@10010086;1@10010096;1@10031015;1@10031016;1@10031017;1@10031014;1@10031013;1@10031012;1@10031011;1@10031010;1@10031009;1@10060105;1@10060205;1@10060305;1@10060405;1@10060505;1@10060605;1@10060705;1";
        }

        /// <summary>
        /// 宠物之核抽奖掉落展示
        /// </summary>
        public static string PetHeXinChouKaRewardItemShow()
        {
            return "10060205;1@10060305;1@10060405;1@10060505;1@10060605;1@10060705;1";
        }


        public static List<int> BaoShiBuff()
        {
            return new List<int>() { 99001042, 99001031, 99001032, 99001011 };
        }

        public static List<int> DonationBuff()
        {
            return new List<int>() { 99003011 , 99003012, 99003013, 99003021, 99003022, 99003023,
        ...
        {
            return new List<string>() { "天下第一勇士", "天下第二勇士", "天下第三勇士" };
        }
        ...
        /// 职业排行榜第一名buff 
        /// </summary>
        public static List<int> CombatRankBuff()
        {
            return new List<int>() {
        ...
        /// 第一个权重大优先显示全区称号
        /// </summary>
        public static List<int> ChengHaoWeight()
        {
            return new List<int>() { 100, 0 };
        }
        ...
        /// 单笔充值奖励
        /// </summary>
        public static Dictionary<int, string> SingleRechargeReward()
        {
            return  new Dictionary<int, string>()
            {
        ...
        /// 洗练次数奖励
        /// </summary>
        public static Dictionary<int, string> ItemXiLianNumReward()
        {
            return new Dictionary<int, string>()
            {
        ...
        /// 与上面的召唤物配置差不多
        /// </summary>
        public static Dictionary<int, int> DefeatedBossIds ()
        {
        return new Dictionary<int, int>() {
            { 70001004, 90000201 },
            { 70001011, 90000202 },
