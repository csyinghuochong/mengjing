...
namespace ET.Server
{
    ...
    public static partial class DragonDungeonComponentSSystem
    {
        ...
        public static CellDungeonInfo GetNextSonCell(this DragonDungeonComponentS self, int cellIndex, int directionType)
        {
        ...
        public static int GetCurentIndex(this DragonDungeonComponentS self)
        {
            return self.GetCellIndex(self.CurrentFubenCell.row, self.CurrentFubenCell.line);
        }

        public static int GetCellIndex(this DragonDungeonComponentS self, int row, int line)
        {
            int rowTotal = self.ChapterConfig.InitSize[0];
            return line * rowTotal + row;
        }

        public static CellDungeonInfo GetByCellIndex(this DragonDungeonComponentS self, int cellIndex)
        {
            int row = cellIndex % self.ChapterConfig.InitSize[0];
            int line = cellIndex / self.ChapterConfig.InitSize[0];
        ...
        public static bool GetCellPassable(this DragonDungeonComponentS self, int row, int line)
        {
        ...
        public static List<int> GetPassableFlag(this DragonDungeonComponentS self, CellDungeonInfo fubenCell = null)
        {
        ...
        public static void OnRecivedHurt(this DragonDungeonComponentS self, long hurtvalue)
        {
            self.HurtValue += hurtvalue;
        }

        public static bool HaveFubenCellNpc(this DragonDungeonComponentS self, int npcType, int cell)
        {
        ...
        public static bool OnKillEvent(this DragonDungeonComponentS self)
        {
            ...
            MapMessageHelper.SendToClient(players, m2C_FubenSettlement);
            FubenHelp.OnDragonSettlement( players, self.ChapterId, self.FubenDifficulty,  starNumber);
            return true;
        }
        ...
        public static bool IsAllMonsterDead(this DragonDungeonComponentS self)
        {
            List<Unit> players = UnitHelper.GetUnitList(self.Scene(), UnitType.Player);
