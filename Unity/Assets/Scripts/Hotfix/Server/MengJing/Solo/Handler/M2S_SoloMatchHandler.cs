namespace ET.Server
{
    ...
    public class M2S_SoloMatchHandler : MessageHandler<Scene, M2S_SoloMatchRequest, S2M_SoloMatchResponse>
    {
        protected override async ETTask Run(Scene scene, M2S_SoloMatchRequest request, S2M_SoloMatchResponse response)
        {
            //收到匹配服务器发来的消息进行匹配处理
