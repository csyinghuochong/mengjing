    ...
    public  void buffSetProperty(BuffS buffS, NumericComponentS heroCom)
    {
        ...
        switch (buffS.mBuffConfig.BuffType)
        {
            ...
            case 1:
                ...
                float NowBuffParameterValue = (float)buffS.mBuffConfig.buffParameterValue + buffS.GetTianfuProAdd((int)BuffAttributeEnum.AddParameterValue);
                ...
                {
                    //神农属性额外处理
                    buffS.NowBuffValue = buffS.NowBuffValue * (1f + heroCom.GetAsFloat(NumericType.Now_ShenNongPro) + heroCom.GetAsFloat(NumericType.Now_ShenNongProNoFight));
                    int nowdamgeType = 2;
                ...
                else
                {
                    ...
                    if (ValueType == 0)
                    {
                        buffS.TheUnitBelongto.GetComponent<HeroDataComponentS>().BuffPropertyUpdate_Long(NowBuffParameterType, (long)buffS.NowBuffValue);
                    }

                    //浮点数
                    if (ValueType == 1)
                    {
                        buffS.TheUnitBelongto.GetComponent<HeroDataComponentS>().BuffPropertyUpdate_Float(NowBuffParameterType, (float)buffS.NowBuffValue);
                    }
                }
                break;
        ...
        switch (buffS.mBuffConfig.BuffType)
        {
            case 1:
                ...
                else
                {
                    ...
                    if (ValueType == 0)
                    {
                        buffS.TheUnitBelongto.GetComponent<HeroDataComponentS>().BuffPropertyUpdate_Long(NowBuffParameterType, (long)buffS.NowBuffValue * -1);
                    }

                    //浮点数
                    if (ValueType == 1)
                    {
                        buffS.TheUnitBelongto.GetComponent<HeroDataComponentS>().BuffPropertyUpdate_Float(NowBuffParameterType, (float)buffS.NowBuffValue * -1);
                    }
                }
                break;
            case 2:
