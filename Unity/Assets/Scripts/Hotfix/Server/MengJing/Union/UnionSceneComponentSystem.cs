...
namespace ET.Server
{
    ...
    public static partial class UnionSceneComponentSystem
    {
        ...
        public static async ETTask OnUnionRaceOver(this UnionSceneComponent self)
        {
            ...
            Log.Console("家族战发放奖励");
            Log.Warning(
                $"allwinunits: {allwinunits}   allfailunits: {allfailunits}  winJingJin: {winJingJin} failJiangJin:{failJiangJin} winunionid: {self.WinUnionId} allJiangjin:{allJiangjin}");
        ...
        public static void GenerateUnionBoss(this UnionSceneComponent self, Scene scene, long unionid)
        {
            ...
            Unit unitMonster = UnitFactory.CreateMonster(scene, monsterID, initPosi,
