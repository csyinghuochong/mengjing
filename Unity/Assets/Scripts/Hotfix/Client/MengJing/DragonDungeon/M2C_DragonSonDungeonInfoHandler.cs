...
namespace ET.Client
{
    ...
    public class M2C_DragonSonDungeonInfoHandler : MessageHandler<Scene, M2C_DragonSonDungeonInfo>
    {
        protected override async ETTask Run(Scene root, M2C_DragonSonDungeonInfo message)
        {
