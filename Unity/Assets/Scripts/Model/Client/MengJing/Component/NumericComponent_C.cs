...
namespace ET.Client
{
    [FriendOf(typeof (NumericComponent_C))]
    public static class NumericComponentClientSystem
    {
        public static float GetAsFloat(this NumericComponent_C self, int numericType)
        {
            return (float)self.GetByKey(numericType) / 10000;
        }

        public static int GetAsInt(this NumericComponent_C self, int numericType)
        {
            return (int)self.GetByKey(numericType);
        }

        public static long GetAsLong(this NumericComponent_C self, int numericType)
        {
            return self.GetByKey(numericType);
        }

        public static void Set(this NumericComponent_C self, int nt, float value)
        {
            self[nt] = (long)(value * 10000);
        }

        public static void Set(this NumericComponent_C self, int nt, int value)
        {
            self[nt] = value;
        }

        public static void Set(this NumericComponent_C self, int nt, long value)
        {
            self[nt] = value;
        }

        public static void SetNoEvent(this NumericComponent_C self, int numericType, long value)
        {
            self.Insert(numericType, value, false);
        }

        public static void Insert(this NumericComponent_C self, int numericType, long value, bool isPublicEvent = true)
        {
        ...
        public static long GetByKey(this NumericComponent_C self, int key)
        {
            long value = 0;
        ...
        public static void Update(this NumericComponent_C self, int numericType, bool isPublicEvent)
        {
        ...
        public static void ApplyValue(this NumericComponent_C self, Unit attack, int numericType, long value, int skillID, bool notice = true, int DamgeType = 0)
        {
            //是否超过指定上限值
    ...
    public class NumericComponent_C: Entity, IAwake, ITransfer
    {
