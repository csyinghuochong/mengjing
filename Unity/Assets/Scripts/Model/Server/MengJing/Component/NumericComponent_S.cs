...
namespace ET.Server
{
	...
	public static class NumericComponentServerSystem
	{
		...
		public static void Reset(this NumericComponent_S self)
		{
			//重置所有属性
		...
		public static float GetAsFloat(this NumericComponent_S self, int numericType)
		{
			return (float)self.GetByKey(numericType) / 10000;
		}

		public static int GetAsInt(this NumericComponent_S self, int numericType)
		{
			return (int)self.GetByKey(numericType);
		}

		public static long GetAsLong(this NumericComponent_S self, int numericType)
		{
			return self.GetByKey(numericType);
		}

		public static void Set(this NumericComponent_S self, int nt, float value)
		{
			self[nt] = (long)(value * 10000);
		}

		public static void Set(this NumericComponent_S self, int nt, int value)
		{
			self[nt] = value;
		}

		public static void Set(this NumericComponent_S self, int nt, long value)
		{
			self[nt] = value;
		}

		public static void SetNoEvent(this NumericComponent_S self, int numericType, long value)
		{
			self.Insert(numericType, value, false);
		}

		public static void SetEvent(this NumericComponent_S self, int numericType, long value, bool notice)
		{
			self.Insert(numericType, value, notice);
		}

		public static void SetEvent(this NumericComponent_S self, int numericType, double value, bool notice)
		{
			self.Insert(numericType, (long)(value * 10000), notice);
		}

		public static void Insert(this NumericComponent_S self, int numericType, long value, bool isPublicEvent = true)
		{
		...
		public static long GetByKey(this NumericComponent_S self, int key)
		{
			long value = 0;
		...
		public static void Update(this NumericComponent_S self, int numericType, bool isPublicEvent)
		{
		...
		public static long ReturnGetFightNumLong(this NumericComponent_S self, int numericType, bool notice = true)
		{
		...
		public static float ReturnGetFightNumfloat(this NumericComponent_S self, int numericType, bool notice = true)
		{
			if (numericType < (int)NumericType.Max)
			{
				numericType = numericType * 100;
		...
		public static void ApplyValue(this NumericComponent_S self, int numericType, long value, bool notice = true, bool check = false)
		{
		...
		public static void ApplyValue(this NumericComponent_S self, Unit attack, int numericType, long value, int skillID, bool notice = true,
		int DamgeType = 0)
		{
			//是否超过指定上限值
			long old = self.GetByKey(numericType);
		...
		/// <param name="DamgeType"></param>
		/// <param name="compare">是否比较变化值</param>
		public static void ApplyChange(this NumericComponent_S self, Unit attack, int numericType, long changedValue, int skillID,
	...
	public class NumericComponent_S: Entity, IAwake, ITransfer, IUnitCache
	{
