...
namespace ET.Server
{
	...
	public static class NumericComponentServerSystem
	{
		...
		public static void ApplyValue(this NumericComponentServer self, int numericType, long value, bool notice = true, bool check = false)
		{
		...
		public static void ApplyValue(this NumericComponentServer self, Unit attack, int numericType, long value, int skillID, bool notice = true,
		int DamgeType = 0)
		{
			//是否超过指定上限值
			long old = self.GetByKey(numericType);
		...
		/// <param name="DamgeType"></param>
		/// <param name="compare">是否比较变化值</param>
		public static void ApplyChange(this NumericComponentServer self, Unit attack, int numericType, long changedValue, int skillID,
