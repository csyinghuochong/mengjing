...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/HD/DecalFinal", false, 85 )]
		public static void ApplyTemplateHDDecalFinal()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "d97cf841c54664948bd4630db116188d" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/HD/Fabric 1", false, 85 )]
		public static void ApplyTemplateHDFabric1()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "92fd308a438663a4687b9afe00c82766" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/HD/Hair 1", false, 85 )]
		public static void ApplyTemplateHDHair1()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "f48afc124b7f08f42976dd27109f9b55" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/HD/Lit 1", false, 85 )]
		public static void ApplyTemplateHDLit1()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "6a1eedc21164e8043a8a6e883b1ee0ff" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/HD/Unlit 1", false, 85 )]
		public static void ApplyTemplateHDUnlit1()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "f879ef02dbfc5fd49935e79cffef5b68" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/Universal/PBR 1", false, 85 )]
		public static void ApplyTemplateUniversalPBR1()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "6c77afc2cc774b44991bade5ff561f51" );
		}
